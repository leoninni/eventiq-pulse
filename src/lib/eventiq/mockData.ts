...
export const candidates: Candidate[] = [
  {
    ...
    projectDescription:
      "An end-to-end retrieval pipeline that indexes internal documentation and serves grounded answers with sub-second latency. Built with hybrid search and a fine-tuned reranker.",
    status: "Interviewed",
    eventId: "hacktum",
    skillProofs: [
  ...
  },
  {
    ...
    projectDescription:
      "A CUDA implementation of frontier-based BFS that outperforms standard CPU baselines on billion-edge graphs. Submitted to a systems track at ETH Build Night.",
    status: "Interested",
    eventId: "hacktum",
    skillProofs: [
  ...
  },
  {
    ...
    projectDescription:
      "A multiplayer whiteboard built on Yjs with offline-first sync. Designed for low-bandwidth classrooms with conflict-free merges across devices.",
    status: "Interested",
    eventId: "starthack",
  },
  {
    ...
    projectDescription:
      "A Spark-streaming pipeline ingesting telemetry from 10k sensors with windowed aggregation and anomaly detection. Production-grade backpressure handling.",
    status: "In Review",
    eventId: "kithack",
    skillProofs: [
  ...
  },
  {
    ...
    projectDescription:
      "A SQLite-compatible query engine compiled to WebAssembly, enabling rich analytics without a backend. Won the systems track at START Hack.",
    status: "Interviewed",
    eventId: "starthack",
    skillProofs: [
  ...
  },
  {
    ...
    projectDescription:
      "A lightweight vision model running at 60fps on edge hardware, trained with synthetic data augmentation. Already piloted at a Bavarian auto supplier.",
  ...
  },
  {
    ...
    projectDescription:
      "An operator that detects failing nodes via custom probes and automatically reschedules workloads with zero downtime. Tested on a 200-node cluster.",
    status: "In Review",
    eventId: "starthack",
    skillProofs: [
  ...
  },
  {
    ...
    projectDescription:
      "Fine-tuned multilingual transformer reaching 94% F1 on a custom enterprise intent dataset across 6 languages.",
    status: "Rejected",
    eventId: "codeberlin",
  },
  {
    ...
    projectDescription:
      "A Kafka-backed inventory service synchronizing stock across 50 warehouses with exactly-once delivery semantics.",
    status: "In Review",
    eventId: "hacktum",
    skillProofs: [
  ...
  },
  {
    ...
    projectDescription:
      "A PPO agent that learns dynamic pricing strategies in simulated marketplaces, outperforming rule-based baselines by 18% revenue.",
    status: "Interested",
    eventId: "hacktum",
  },
  {
    ...
    projectDescription:
      "A real-time sensor fusion stack on FreeRTOS combining LIDAR and IMU at sub-millisecond latency for autonomous robotics.",
    status: "Interested",
    eventId: "codeberlin",
    skillProofs: [
  ...
  },
  {
    ...
    projectDescription:
      "A browser-based code editor with sub-100ms multiplayer sync, Monaco integration, and language-server protocol support.",
    status: "Rejected",
    eventId: "codeberlin",
  },
  {
    ...
    projectDescription:
      "Built a modular evaluation harness for enterprise RAG pipelines that tracks faithfulness, relevance, and latency across 12 retrieval strategies.",
    status: "Interested",
    eventId: "hacktum",
    communityRoles: ["tum-ai"],
    skillProofs: [{ skill: "LLMs", source: "TUM AI Society — LLM evaluation project lead" }],
  },
  {
    id: "c-excl-2",
    name: "Tobias K.",
    ...
    projectDescription:
      "Instrumented a distributed PyTorch training loop with real-time loss tracking and automatic checkpoint selection. Reduced wasted GPU hours by 40%.",
    status: "In Review",
    eventId: "hacktum",
    communityRoles: ["tum-ai"],
  },
  {
    ...
    projectDescription:
      "A live dashboard that ingests benchmark results from HuggingFace and renders interactive comparison charts, making model selection decisions visual.",
    status: "Interested",
    eventId: "hacktum",
    communityRoles: ["tum-ai"],
  },
...
export const universityProfiles: UniversityProfile[] = [
  ...
  },
  {
    ...
    lng: 6.63,
    candidates: 55,
    topSkills: ["Python", "Robotics", "ROS"],
    roleAffinity: "Robotics · ML/AI",
  },
  {
    id: "tudelft",
    name: "TU Delft",
    ...
    lng: 4.36,
    candidates: 45,
    topSkills: ["C++", "ROS", "Computer Vision"],
    roleAffinity: "Robotics · Systems",
  },
  {
    id: "ecole-poly",
    ...
    lng: 2.21,
    candidates: 40,
    topSkills: ["Python", "ML", "Robotics"],
    roleAffinity: "ML/AI · Robotics",
  },
  {
    id: "tuwien",
    name: "TU Wien",
    ...
    lng: 16.36,
    candidates: 30,
    topSkills: ["C++", "Embedded", "Robotics"],
    roleAffinity: "Robotics · Embedded",
  },
  {
    id: "kth",
  ...
  },
  {
    ...
    lng: 16.93,
    candidates: 25,
    topSkills: ["Python", "Embedded", "C++"],
    roleAffinity: "Robotics",
  },
  {
    id: "polimi",
    ...
    lng: 9.23,
    candidates: 40,
    topSkills: ["Python", "C++", "Automation"],
    roleAffinity: "Robotics · Automation",
  },
  // North America
  {
    id: "mit",
    ...
    lng: -71.09,
    candidates: 42,
    topSkills: ["ML", "Systems", "Research"],
    roleAffinity: "ML/AI · Research",
  },
  {
    id: "harvard",
    name: "Harvard",
    ...
    lng: -71.12,
    candidates: 18,
    topSkills: ["CS Theory", "Python"],
    roleAffinity: "Research",
  },
  {
    id: "stanford",
    name: "Stanford",
    ...
    lng: -122.17,
    candidates: 51,
    topSkills: ["ML", "LLMs", "TypeScript"],
    roleAffinity: "ML/AI · Frontend",
  },
  {
    id: "berkeley",
    name: "UC Berkeley",
    ...
    lng: -122.26,
    candidates: 33,
    topSkills: ["Systems", "Rust", "ML"],
    roleAffinity: "Systems · ML/AI",
  },
  {
    id: "columbia",
    name: "Columbia",
    ...
    lng: -73.96,
    candidates: 26,
    topSkills: ["TypeScript", "Python", "Data"],
    roleAffinity: "Frontend · Data",
  },
  {
    id: "nyu",
    name: "NYU",
  ...
  },
  {
    ...
    lng: -80.54,
    candidates: 29,
    topSkills: ["Go", "Systems", "DevOps"],
    roleAffinity: "Backend · Systems",
  },
  {
    id: "utaustin",
    name: "UT Austin",
    ...
    lng: -97.74,
    candidates: 19,
    topSkills: ["C++", "Embedded", "Systems"],
    roleAffinity: "Systems · Embedded",
  },
  {
    id: "uw",
    ...
    lng: -122.31,
    candidates: 22,
    topSkills: ["Cloud", "Go", "ML"],
    roleAffinity: "Backend · ML/AI",
  },
  // Asia
  {
    id: "nus",
    ...
    lng: 103.77,
    candidates: 22,
    topSkills: ["Python", "ML", "Cloud"],
    roleAffinity: "ML/AI · Backend",
  },
  {
    id: "ntu",
    name: "NTU Singapore",
    ...
    lng: 103.68,
    candidates: 15,
    topSkills: ["AI", "Robotics", "C++"],
    roleAffinity: "Robotics · AI",
  },
  {
    id: "utokyo",
    name: "Univ. of Tokyo",
  ...
  },
  {
    ...
    lng: 126.95,
    candidates: 24,
    topSkills: ["ML", "AI", "Python"],
    roleAffinity: "ML/AI",
  },
  {
    id: "snu",
    name: "Seoul National Univ.",
    shortName: "SNU",
    location: "Seoul",
    city: "seoul",
    continent: "asia",
    ...
    lng: 126.95,
    candidates: 18,
    topSkills: ["Data", "Python", "ML"],
    roleAffinity: "Data · ML/AI",
  },
  {
    id: "iisc",
    name: "IISc Bangalore",
  ...
  },
  {
    ...
    lng: 77.57,
    candidates: 21,
    topSkills: ["C++", "Algorithms", "Python"],
    roleAffinity: "Systems · Backend",
  },
  {
    id: "tsinghua",
  ...
  },
  {
    ...
    lng: 121.43,
    candidates: 19,
    topSkills: ["Systems", "Cloud", "Go"],
    roleAffinity: "Backend · Cloud",
  },
];
...
export const studentCommunities: StudentCommunity[] = [
  ...
  {
    id: "delft-rsa",
    name: "Delft Robotics Student Association",
    type: "Robotics",
    university: "TU Delft",
    city: "delft",
    continent: "europe",
  ...
  // ── Europe — France ────────────────────────────────────────────────────────
  {
    ...
    name: "Unaite",
    type: "Robotics",
    university: "Grandes Écoles Paris",
    city: "paris",
    continent: "europe",
    members: 200,
    topSkills: ["Python", "ML", "Robotics"],
  ...
  // ── Asia ───────────────────────────────────────────────────────────────────
  {
    ...
    continent: "asia",
    members: 180,
    topSkills: ["Python", "Cloud"],
  },
  {
    id: "utokyo-robo",
    name: "UTokyo Robotics Lab",
    type: "Robotics",
  ...
  {
    id: "iisc-ml",
    name: "IISc Machine Learning Group",
    type: "AI/ML",
...
export const cityMarkers: CityMarker[] = [
  ...
  { id: "karlsruhe", name: "Karlsruhe", continent: "europe", lat: 49.01, lng: 8.4 },
  ...
  { id: "toronto", name: "Toronto", continent: "north-america", lat: 43.66, lng: -79.4 },
  ...
  // Asia
  { id: "singapore", name: "Singapore", continent: "asia", lat: 1.3, lng: 103.77 },
  ...
  { id: "beijing", name: "Beijing", continent: "asia", lat: 39.9, lng: 116.4 },
...
export const clubPartnerships: ClubPartnership[] = [
  ...
  {
    clubId: "rwth-robotics",
    totalSlots: 3,
    takenSlots: 1,
    availableFormats: ["workshop", "challenge-sprint", "private-hackathon"],
  }, // Robotics Collective Aachen — ESRA
  {
    clubId: "kit-kaira",
    totalSlots: 2,
    takenSlots: 0,
  ...
  // Austria
  {
    clubId: "wien-robotics",
    totalSlots: 2,
    takenSlots: 0,
    availableFormats: ["workshop", "challenge-sprint", "private-hackathon"],
  }, // TU Wien Robotics Club — ESRA
  // France
  {
    clubId: "paris-unaite",
    totalSlots: 3,
